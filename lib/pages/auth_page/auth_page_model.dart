...
class AuthPageModel extends FlutterFlowModel<AuthPageWidget> {
  ...
  // Stores action output result for [Backend Call - API (LoginApliCall)] action in Button widget.
  ...
  // Stores action output result for [Backend Call - API (SignUpApliCall)] action in Button widget.
  ApiCallResponse? apiResultqqw;
  // Stores action output result for [Backend Call - API (LoginApliCall)] action in Button widget.
  ApiCallResponse? authLoginResponse;
  // Stores action output result for [Backend Call - API (AddStudent)] action in Button widget.
  ApiCallResponse? apiResulta5y;
