...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    autoEvaluacionGruposAuthUserSubject.add(
      AutoEvaluacionGruposAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<AutoEvaluacionGruposAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  AutoEvaluacionGruposAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = AutoEvaluacionGruposAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    autoEvaluacionGruposAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
AutoEvaluacionGruposAuthUser? currentUser;
